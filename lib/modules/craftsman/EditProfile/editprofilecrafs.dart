...
class EditProfileCrafs extends StatefulWidget {
  const EditProfileCrafs({super.key});

  @override
  State<EditProfileCrafs> createState() => _EditProfileCrafsState();
}

class _EditProfileCrafsState extends State<EditProfileCrafs> {
  File? updateImage;
  String? imageUrl;
