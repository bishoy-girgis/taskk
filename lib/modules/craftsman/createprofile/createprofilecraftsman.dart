...
import 'package:sanai3ey/modules/craftsman/createprofile/craftsman-gender.dart';
...
class CreateProfileCraftsmanPage extends StatefulWidget {
  const CreateProfileCraftsmanPage({super.key});

  @override
  State<CreateProfileCraftsmanPage> createState() => _CreateProfileCraftsmanPage();
}

class _CreateProfileCraftsmanPage extends State<CreateProfileCraftsmanPage> {
                          ...
                          DefaultButtom(
                              onPressed: (){
                                Navigator.push(context,MaterialPageRoute(
                                  builder: (_) => const CraftsmanGender(),
                                ),
                                );
                              },
                              text: 'Next'
